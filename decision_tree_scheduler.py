...
---------------------------
Goal:
    This script performs hyperparameter tuning for a Decision Tree Classifier
    using GridSearchCV and RepeatedStratifiedKFold cross-validation.
...
Overview of Workflow:
    ...
    5. Use repeated stratified cross-validation to ensure stability.
    6. Use GridSearchCV to identify the best hyperparameter combination.
    7. Evaluate the best model on both training and test sets.

Notes:
- The code includes commented-out hyperparameter ranges showing the iterative exploration process.
- (Optional) Saves the best configuration to a CSV file.
"""
...
param_grid = [
    # Allow: (A) vary max_depth with max_leaf_nodes=None
    {
        ...
        "ccp_alpha"         : [0.0, 0.0004, 0.00041, 0.00042, 0.00043, 0.00044, 0.00045, 0.00046, 0.00046, 0.00047, 0.00048, 0.00049]
    },
    # Allow: (B) Vary max_leaf_nodes with max_depth=None
    {
        "criterion"         : ['gini'],
        "max_depth"         : [None],
        "max_leaf_nodes"    : [None, 6, 9, 12, 15, 18, 21, 24, 27, 30, 40, 50, 60, 70, 80, 81, 82, 83, 84, 85, 86, 87, 88, 89],
        "min_samples_split" : [2, 3, 4, 5, 6, 7, 8, 9, 10],
        "ccp_alpha"         : [0.0, 0.0004, 0.00041, 0.00042, 0.00043, 0.00044, 0.00045, 0.00046, 0.00046, 0.00047, 0.00048, 0.00049]
    },
